...
public class GraphicsScalingApp extends Application {
    ...
    public static final String APP_ICON = "http://icons.iconarchive.com/icons/hopstarter/soft-scraps/128/Zoom-icon.png";
    public static final String ZOOM_RESET_ICON = "http://icons.iconarchive.com/icons/hopstarter/soft-scraps/24/Zoom-icon.png";
    public static final String ZOOM_OUT_ICON = "http://icons.iconarchive.com/icons/hopstarter/soft-scraps/24/Zoom-Out-icon.png";
    public static final String ZOOM_IN_ICON = "http://icons.iconarchive.com/icons/hopstarter/soft-scraps/24/Zoom-In-icon.png";
    public static final String CLOSE_ICON = "http://icons.iconarchive.com/icons/hopstarter/soft-scraps/24/Button-Close-icon.png";
}